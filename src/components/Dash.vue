<template>
  <div class="wrapper">
    <header class="main-header">
      <a href="/" class="logo">
        ...
        <div class="container logo-lg">
          ...
          <div class="pull-left info">Endicon</div>
        </div>
      </a>
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          ...
          <div class="pull-left info">
            ...
            <a href="javascript:;" @click="sair"><i class="fa fa-circle text-success"></i> Online</a>
          </div>
        </div>
        ...
        <ul class="sidebar-menu">
          <li class="header">Dados Gerais</li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/regionais"><i class="fa fa-desktop"></i><span class="page">Regionais</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/polos"><i class="fa fa-table"></i><span class="page">Polos</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/localidadespolo"><i class="fa fa-desktop"></i><span class="page">Localidades de Polos</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/funcoes"><i class="fa fa-table"></i><span class="page">Cargos</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/funcionarios"><i class="fa fa-desktop"></i><span class="page">Funcionários</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/treinamentos"><i class="fa fa-table"></i><span class="page">Treinamentos</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/processos"><i class="fa fa-table"></i><span class="page">Processos</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/tiposprocesso"><i class="fa fa-desktop"></i><span class="page">Nomes de processos</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/equipamentoscoletivos"><i class="fa fa-table"></i><span class="page">Equipamentos Coletivos</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/equipamentosindividuais"><i class="fa fa-desktop"></i><span class="page">Equipamentos Individuais</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/perguntasrisco"><i class="fa fa-table"></i><span class="page">Perguntas da APR</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/riscosidentificados"><i class="fa fa-desktop"></i><span class="page">Riscos da APR</span></router-link></li>
          ...
          <li class="header">Registros do SESMT</li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/treinamentosrealizados"><i class="fa fa-desktop"></i><span class="page">Treinamentos Realizados</span></router-link></li>
          <li class="pageLink" v-on:click="toggleMenu"><router-link to="/analisesrisco"><i class="fa fa-table"></i><span class="page">Análise Preliminar de Risco</span></router-link></li>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; {{year}} <a href="javascript:;">Endicon</a>.</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
</template>
...
module.exports = {
  ...
  methods: {
    ...
    sair () {
      ...
      window.sessionStorage.removeItem('permissao')
