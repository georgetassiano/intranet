        ...
        <div class="col-sm-12">
          <div class="box box-info">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Novo Risco Identificado</h3>
  ...
  export default {
    ...
    methods: {
      enviar () {
        ...
        this.$http.post('http://localhost:8000/dados/riscosidentificados/novo_riscoidentificado', {
          'Nome': this.nome
        }).then((response) => {
          console.log('sucess ', response.body)
          response.json().then((data) => {
            this.$store.commit('ADD_RISCOIDENTIFICADO', {
              'id': data.id,
              'nome': this.nomeCopia
            })
          })
