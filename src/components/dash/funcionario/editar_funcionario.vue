        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Alterar Funcionario</h3>
...
<script>
  export default {
    ...
    watch: {
      funcionario () {
        this.nome = this.$store.state.funcionarios[this.$route.query.index].nome
        this.dataNascimento = this.$store.state.funcionarios[this.$route.query.index].dataNascimento
        this.sexo = this.$store.state.funcionarios[this.$route.query.index].sexo
        this.estadoCivil = this.$store.state.funcionarios[this.$route.query.index].estadoCivil
        this.inicioFuncao = this.$store.state.funcionarios[this.$route.query.index].inicioFuncao
        this.grauInstrucao = this.$store.state.funcionarios[this.$route.query.index].grauInstrucao
        this.estadoInstrucao = this.$store.state.funcionarios[this.$route.query.index].estadoInstrucao
        this.inicioRefeicao = this.$store.state.funcionarios[this.$route.query.index].inicioRefeicao
        this.fimRefeicao = this.$store.state.funcionarios[this.$route.query.index].fimRefeicao
        this.turnoTrabalho = this.$store.state.funcionarios[this.$route.query.index].turnoTrabalho
        this.nacionalidade = this.$store.state.funcionarios[this.$route.query.index].nacionalidade
        this.endereco = this.$store.state.funcionarios[this.$route.query.index].local.endereco
        this.vm.searchPlace = this.$store.state.funcionarios[this.$route.query.index].local.endereco
        this.cep = this.$store.state.funcionarios[this.$route.query.index].local.cep
        this.posicaoGeografica = this.$store.state.funcionarios[this.$route.query.index].local.posicaoGeografica
        this.estado = this.$store.state.funcionarios[this.$route.query.index].local.estado
        this.cidade = this.$store.state.funcionarios[this.$route.query.index].local.cidade
        this.funcaoSelecionada = this.$store.state.funcionarios[this.$route.query.index].funcao
        this.localidadePoloSelecionada = this.$store.state.funcionarios[this.$route.query.index].localidadePolo
      },
      dados () {
    ...
    methods: {
      alterar () {
        ...
        console.log('entrou')
        this.$http.put('http://localhost:8000/dados/locais/' + this.funcionario.local.id, {
          ...
          this.$http.put('http://localhost:8000/dados/funcionarios/' + this.funcionario.matricula, {
            'Nome': this.nome,
